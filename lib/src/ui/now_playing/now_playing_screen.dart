...
import 'package:ProvyTunes/src/models/playerstate.dart';
import 'package:ProvyTunes/src/ui/now_playing/album_art_container.dart';
import 'package:ProvyTunes/src/ui/now_playing/empty_album_art.dart';
import 'package:ProvyTunes/src/ui/now_playing/music_control.dart';
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: StreamBuilder<MapEntry<PlayerState, Song>>(
                    ...
                    builder: (BuildContext context,
                        AsyncSnapshot<MapEntry<PlayerState, Song>> snapshot) {
                      return songInfoBuilder(
                          snapshot, _radius, _globalBloc, _albumArtSize);
                    },
                  ),
                ),
                Container(
