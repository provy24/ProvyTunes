...
import 'package:ProvyTunes/src/common/music_icons.dart';
import 'package:ProvyTunes/src/models/playback.dart';
...
class PreferencesBoard extends StatelessWidget {
  ...
  PreferencesBoard({@required PanelController controller})
      ...
      children: <Widget>[
          ...
          builder: (BuildContext context,
            ...
            if (!snapshot.hasData) {
              return Icon(CupertinoIcons.heart,
                  size: 32, color: Color(0xFFC7D2E3));
            }
        ...
        StreamBuilder<List<Playback>>(
          ...
          builder:
            ...
            if (!snapshot.hasData) {
              return Icon(CupertinoIcons.loop,
                  size: 34, color: Color(0xFFC7D2E3));
            }
