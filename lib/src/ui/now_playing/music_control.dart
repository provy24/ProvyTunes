...
import 'package:ProvyTunes/src/ui/now_playing/preferences_board.dart';
...
class MusicControl extends StatelessWidget {
  ...
  MusicControl({@required PanelController controller})
  ...
  String getRunningDuration(Duration duration) {
    ...
    if (twoDigits(duration.inHours) != '00' &&
        twoDigits(duration.inHours) != null) {
        ...
        builder: (BuildContext context,
          ...
          if (!snapshot.hasData ||
              snapshot.hasData != null &&
                  snapshot.data.value.key == PlayerState.stopped) {
            return Slider(
              value: 0,
    ...
    return ClipPath(
        ...
        child: Container(
          ...
          child: Column(children: [
            ...
            Container(
                padding:
                    EdgeInsets.only(top: 14, left: 25, right: 25, bottom: 18),
