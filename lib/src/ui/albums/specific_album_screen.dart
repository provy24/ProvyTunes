...
import 'package:ProvyTunes/src/models/album.dart';
import 'package:ProvyTunes/src/models/playerstate.dart';
import 'package:ProvyTunes/src/ui/all_songs/song_tile.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          leading: IconButton(
            icon: Icon(Icons.arrow_back, color: Color(0xFF0D1832), size: 35),
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                        image: albumImageView(), fit: BoxFit.cover),
