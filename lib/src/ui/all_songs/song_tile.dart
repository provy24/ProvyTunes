    ...
    return Flexible(
      ...
      child: Container(
        ...
        child: AnimatedCrossFade(
          ...
          crossFadeState: _isSelectedSong && _state == PlayerState.playing
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                ...
                style: TextStyle(
                    fontSize: 14,
                    color: Color.fromRGBO(163, 178, 201, 1),
                    letterSpacing: 0.1),
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
              ),
  ...
  gradientDecoration(_isSelectedSong) {
    return BoxDecoration(
      gradient: _isSelectedSong
          ? LinearGradient(
              colors: [
                Color.fromRGBO(210, 237, 250, 1).withOpacity(1),
                Color.fromRGBO(240, 248, 252, 1)
              ],
            )
          : null,
    );
